...
const CryptoDetails = () => {
  ...
  const { coinData, getCoinData, currency } = useCryptoValue();
      ...
      >
        {coinData ? (
          ...
          `}
              ...
              <div className='flex flex-col w-full mt-4 justify-between sm:mt-0'>
                <span className='text-sm capitalize text-gray-100'>
                  total volume
                </span>
                <h2 className='text-base font-bold'>
          ...
          <div className='w-full min-h-[60vh] h-full flex justify-center items-center'>
            <div className='w-full h-full flex justify-center items-center absolute  left-[2%]'>
