...
const Filter = () => {
  const { setCurrency, setSortBy, reset } = useCryptoValue();
  ...
  return (
    <div
      className='w-full lg:h-12 h-full lg:border-2 border-solid lg:border-gray-100 rounded-lg
      ...
      <div className='flex lg:mr-7 justify-between mt-4 lg:mt-0 sm:flex-row flex-col relative'>
        <form className='relative flex items-center font-nunito md:mr-12 mr-1'>
          <label
            ...
            mr-2 font-bold  sm:text-base text-sm sm:font-bold 
            '
          >
            currency:
          </label>
