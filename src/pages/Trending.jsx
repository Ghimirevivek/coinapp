...
import { useTrendingValue } from '../context/TrendingContext';
import TrendingCoin from '../components/TrendingCoin';
import { Outlet } from 'react-router-dom';
const Trending = () => {
  const { trendData, resetTrendData } = useTrendingValue();
